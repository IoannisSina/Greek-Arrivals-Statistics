...
if __name__ == '__main__':
    ...
    #button placement 
    btn1 = tk.Button(window, text=title1, bg="black", fg="cyan", width=200, height=200, font=("Arial",10,"bold"), command=buttonClick1)
    ...
    btn2 = tk.Button(window, text=title2, bg="black", fg="cyan", font=("Arial",10,"bold"), command=lambda : buttonClick2(combo))
    btn2.place(x = 300, y = 0, width = 300, height = 130)

    btn3 = tk.Button(window, text=title3, bg="black", fg="cyan", font=("Arial",10,"bold"), command=buttonClick3)
    btn3.place(x = 0, y = 150, width = 300, height = 150)

    btn4 = tk.Button(window, text=title4, bg="black", fg="cyan", font=("Arial",10,"bold"), command=buttonClick4)
    btn4.place(x = 300, y = 150, width = 300, height = 150)

    btn5 = tk.Button(window, text=title5, bg="green", fg="black", font=("Arial",10,"bold"), command=buttonClick5)
    btn5.place(x = 0, y = 300, width = 300, height = 150)

    btn6 = tk.Button(window, text=title6, bg="green", fg="black", font=("Arial",10,"bold"), command=buttonClick6)
